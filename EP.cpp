...
// Inicializa vias e distancias (respectivamente com -1 e infinito)
void inicializaGrafoAdj(VERTICE *g, int v, int origem) 
{
    int i;
    for (i = 0; i < v; i++)
    {
...
void buscaDijkstra(VERTICE *g, int origem, int v)
{
    if(origem <= 0)
        return;
...
NO *caminho(int N, int A, int *ijpeso, int *aberto, int inicio, int fim, int chave)
{
    ...
    int distanciaComChave = 2147483647, distanciaSemChave = 2147483647;
